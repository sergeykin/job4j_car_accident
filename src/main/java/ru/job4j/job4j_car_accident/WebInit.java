...
import ru.job4j.job4j_car_accident.config.DataConfig;
import ru.job4j.job4j_car_accident.config.HbmConfig;
import ru.job4j.job4j_car_accident.config.WebConfig;
